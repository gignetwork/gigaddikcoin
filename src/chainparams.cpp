...
// Copyright (c) 2015-2024 The GigAddik Coin developers
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (1, uint256("0x00000853ef20244a35b8c2ce5e3c80b3fc6c92e24631d0e8d5ddcf7a77184f48"))
    (151, uint256("0x00000020a48457d24483b2584e7807875ee9a7b41746e4cfa2610126ec42b51c"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1674765810, // * UNIX timestamp of last checkpoint block
    520889,          // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 5369;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // GigAddik starting difficulty is 1 / 2^12
        ...
        nToCheckBlockUpgradeMajority = 5400; // Approximate expected amount of blocks in 7 days (1440*7.5)
        nMinerThreads = 0;
        nTargetSpacing = 2 * 60;                        // 2 minute
        nTargetTimespan = 80 * 60;                      // 80 minutes
        nTimeSlotLength = 30;                           // 15 seconds
        nTargetTimespan_V2 = 2 * nTimeSlotLength * 60;  // 60 minutes
        nMaturity = 100;
        ...
        nLastPOWBlock = 1000;
        nGigAddikBadBlockTime = 4070908800; // Skip nBit validation of Block 259201 per PR #915
        nGigAddikBadBlocknBits = 0x00; // Skip nBit validation of Block 259201 per PR #915
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "DO NOT COMPILE, pszTimestamp WILL BE UPDATED ON JANUARY 15, 2024";
        ...
        vSeeds.push_back(CDNSSeedData("seed1", "seed1.addik.co"));
	vSeeds.push_back(CDNSSeedData("seed2", "seed2.addik.co"));
	vSeeds.push_back(CDNSSeedData("seed3", "seed3.addik.co"));
	vSeeds.push_back(CDNSSeedData("seed4", "seed4.addik.co"));
        ...
        // 761 BIP44 coin type is from https://github.com/satoshilabs/slips/blob/master/slip-0044.md
        base58Prefixes[EXT_COIN_TYPE] = boost::assign::list_of(0x800002f9).convert_to_container<std::vector<unsigned char> >(); 
        ...
        nBudgetCycleBlocks = 21600; //!< Amount of blocks in a months period of time (using 2 minutes per) = (60*24*30)
        strSporkPubKey = "04524691053ad6c9834f8539cefff1e5ed6d11f44ca63ae519701833ad2d01b67abb4f22c4f9524126a59562fb9712e572b5850566053d0bd3d294fa56a5716715";
        strObfuscationPoolDummyAddress = "";
        nStartMasternodePayments = 1705233600;
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nLastPOWBlock = 1000;
        nGigAddikBadBlockTime = 1489001494; // Skip nBit validation of Block 259201 per PR #915
        nGigAddikBadBlocknBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        nMaturity = 15;
        nStakeMinDepth = 100;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet gigaddik addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 135);  // Testnet gigaddik script addresses start with 'w'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 125);     // starting with 's'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet gigaddik BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet gigaddik BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet gigaddik BIP44 coin type is '1' (All coin's testnet default)
