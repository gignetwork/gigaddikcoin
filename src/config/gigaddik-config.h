/* src/config/gigaddik-config.h.  Generated from gigaddik-config.h.in by configure.  */
/* src/config/gigaddik-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://github.com/addik.co/gigaddik/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "GigAddik Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "GigAddik Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "gigaddik"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://addik.co/"
