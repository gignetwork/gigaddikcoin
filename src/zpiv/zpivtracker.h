...
#ifndef GigAddik_ZGIGTRACKER_H
#define GigAddik_ZGIGTRACKER_H
...
public:
    CzGIGTracker(std::string strWalletFile);
    ~CzGIGTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzGIGWallet* zGIGWallet = NULL);
