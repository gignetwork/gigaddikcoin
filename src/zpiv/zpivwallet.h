// Copyright (c) 2017-2018-2024 The GigAddik Coin developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef GigAddik_ZGIGWALLET_H
#define GigAddik_ZGIGWALLET_H
...
public:
    CzGIGWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZGIG(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZGIG(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
