...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("GigAddik Core gigaddik-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  gigaddik-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded gigaddik transaction") + "\n" +
                               "  gigaddik-tx [options] -create [commands]   " + _("Create hex-encoded gigaddik transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded gigaddik transaction
