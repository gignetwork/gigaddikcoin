// Copyright (c) 2017-2020-2024 The GigAddik Coin developers
    ...
    model(0)
{
    ...
    // Title
    ui->labelTitle->setText(tr("Select zGIG Denominations to Spend"));
    ...
    for (const CMintMeta& mint : setMints) {
        ...
        if(!fSpendable) {
            ...
            if(nConfirmations < Params().Zerocoin_MintRequiredConfirmations())
                ...
                strReason = "Your wallet is locked. Impossible to spend zGIG.";
            else if (!mint.isSeedCorrect)
                strReason = "The zGIG seed used to mint this zGIG is not the same as currently hold in the wallet";
            else
