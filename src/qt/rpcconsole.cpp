                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzGIGPathCustom = GetArg("-zpivbackuppath", "");
    ...
    if(!strzGIGPathCustom.empty()) {
        ui->wallet_customzpivbackuppath->setText(QString::fromStdString(strzGIGPathCustom));
        ui->wallet_customzpivbackuppath_label->setVisible(true);
        ui->wallet_customzpivbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzGIGPathCustom.empty()) && nCustomBackupThreshold > 0) {
