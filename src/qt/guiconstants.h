...
// Copyright (c) 2015-2018-2024 The GigAddik Coin developers
...
/* GigAddik GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "GigAddik"
#define QAPP_ORG_DOMAIN "addik.co"
#define QAPP_APP_NAME_DEFAULT "GigAddik-Qt"
#define QAPP_APP_NAME_TESTNET "GigAddik-Qt-testnet"
