...
/** Utility functions used by the GigAddik Qt UI.
 */
namespace GUIUtil
{
...
// Render GigAddik addresses in monospace font
...
// Parse "gigaddik:" URI into recipient object, return true on successful parsing
