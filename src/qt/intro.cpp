...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("GigAddik Core"),
     ...
     * override -datadir in the gigaddik.conf file in the default data directory
     * (to be consistent with gigaddikd behavior)
     */
