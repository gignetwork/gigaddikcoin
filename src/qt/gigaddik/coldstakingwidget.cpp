...
#include "qt/gigaddik/coldstakingwidget.h"
#include "qt/gigaddik/forms/ui_coldstakingwidget.h"
#include "qt/gigaddik/qtutils.h"
#include "amount.h"
#include "guiutil.h"
#include "qt/gigaddik/requestdialog.h"
#include "qt/gigaddik/tooltipmenu.h"
#include "qt/gigaddik/furlistrow.h"
...
ColdStakingWidget::ColdStakingWidget(GigAddikGUI* parent) :
    PWidget(parent),
    ...
    isLoading(false)
{
    ...
    /* Subtitle */
    ui->labelSubtitle1->setText(tr("You can delegate your GIGs, letting a hot node (24/7 online node)\nstake on your behalf, while you keep the keys securely offline."));
    ...
    ui->labelSubtitle2->setText(tr("Accept GIG delegation / Delegate GIG"));
    ...
    ui->btnCoinControl->setSubTitleClassAndText("text-subtitle", "Select GIG outputs to delegate.");
...
void ColdStakingWidget::updateStakingTotalLabel()
{
    ...
    ui->labelStakingTotal->setText(tr("Total Staking: %1").arg(
            (total == 0) ? "0.00 GIG" : GUIUtil::formatBalance(total, nDisplayUnit))
    );
}
