...
#include "qt/gigaddik/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/gigaddik/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(GigAddikGUI* _window, QWidget *parent) :
