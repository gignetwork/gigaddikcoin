...
#include "qt/gigaddik/settings/settingssignmessagewidgets.h"
#include "qt/gigaddik/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(GigAddikGUI* _window, QWidget *parent) :
