...
#include "qt/gigaddik/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/gigaddik/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(GigAddikGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(){
    ...
    message(CMD_REPLY, (tr("Welcome to the GigAddik RPC console.") + "<br>" +
