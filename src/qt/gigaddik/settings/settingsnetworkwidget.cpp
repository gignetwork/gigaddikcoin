...
#include "qt/gigaddik/settings/settingsnetworkwidget.h"
#include "qt/gigaddik/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/gigaddik/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(GigAddikGUI* _window, QWidget *parent) :
