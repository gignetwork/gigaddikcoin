...
#include "qt/gigaddik/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/gigaddik/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(GigAddikGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to GigAddikGUI::handleRestart()
