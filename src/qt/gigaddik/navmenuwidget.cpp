...
#include "qt/gigaddik/forms/ui_navmenuwidget.h"
...
NavMenuWidget::NavMenuWidget(GigAddikGUI *mainWindow, QWidget *parent) :
    ...
    ui(new Ui::NavMenuWidget)
{
    ...
    setCssProperty(ui->imgLogo, "img-nav-logo-gigaddik");
