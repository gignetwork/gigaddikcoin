...
#include "qt/gigaddik/forms/ui_topbar.h"
#include <QPixmap>
#include "qt/gigaddik/lockunlock.h"
#include "qt/gigaddik/qtutils.h"
#include "qt/gigaddik/receivedialog.h"
...
TopBar::TopBar(GigAddikGUI* _mainWindow, QWidget *parent) :
...
void TopBar::loadWalletModel(){
    ...
    // update the display unit, to not use the default ("GigAddik")
    updateDisplayUnit();
