...
#include "qt/gigaddik/forms/ui_receivewidget.h"
...
#include "qt/gigaddik/addressholder.h"
...
ReceiveWidget::ReceiveWidget(GigAddikGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive GIG."));
