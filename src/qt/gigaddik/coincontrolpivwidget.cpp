...
#include "qt/gigaddik/coincontrolpivwidget.h"
#include "qt/gigaddik/forms/ui_coincontrolpivwidget.h"
    ...
    ui(new Ui::CoinControlPivWidget)
{
    ...
    ui->labelTitle->setText("Select GIG Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("GIG");
    ...
    ui->labelValueAfter->setText("0.00 GIG");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 GIG");
    ui->labelValueFee->setText("0.00 GIG");
