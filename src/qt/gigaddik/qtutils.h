...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, GigAddikGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, GigAddikGUI *gui, double posX = 3);
