...
#include "qt/gigaddik/forms/ui_addresseswidget.h"
#include "qt/gigaddik/addresslabelrow.h"
#include "qt/gigaddik/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(GigAddikGUI* parent) :
    PWidget(parent),
    ui(new Ui::AddressesWidget)
{
    ...
    // Address
    ui->labelAddress->setText(tr("Enter GigAddik address"));
