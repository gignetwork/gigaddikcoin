...
#ifndef GigAddik_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define GigAddik_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //GigAddik_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
