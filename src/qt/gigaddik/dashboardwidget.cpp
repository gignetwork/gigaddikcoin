...
#include "qt/gigaddik/forms/ui_dashboardwidget.h"
#include "qt/gigaddik/sendconfirmdialog.h"
#include "qt/gigaddik/txrow.h"
...
DashboardWidget::DashboardWidget(GigAddikGUI* parent) :
    PWidget(parent),
    ui(new Ui::DashboardWidget)
{
    ...
    // Staking Information
    ui->labelMessage->setText(tr("Amount of GIG staked."));
    ...
    ui->labelAmountPiv->setText("0 GIG");
    ...
    ui->btnHowTo->setText(tr("How to get GIG"));
...
void DashboardWidget::loadWalletModel(){
    ...
    // update the display unit, to not use the default ("GIG")
    updateDisplayUnit();
}
...
const QMap<int, std::pair<qint64, qint64>> DashboardWidget::getAmountBy() {
    ...
    for (int i = 0; i < size; ++i) {
        ...
        bool isPiv = modelIndex.data(TransactionTableModel::TypeRole).toInt() != TransactionRecord::StakeZGIG;
...
bool DashboardWidget::loadChartData(bool withMonthNames) {
    ...
    chartData->amountsByCache = getAmountBy(); // pair GIG, zGIG
...
void DashboardWidget::onChartRefreshed() {
    ...
    // init sets
    set0 = new QBarSet("GIG");
    set1 = new QBarSet("zGIG");
