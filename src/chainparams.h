 ...
 * GigAddik system. There are three: the main network on which people trade goods
...
public:
    ...
    int GigAddikBadBlockTime() const { return nGigAddikBadBlockTime; }
    int GigAddikBadBlocknBits() const { return nGigAddikBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nGigAddikBadBlockTime;
    unsigned int nGigAddikBadBlocknBits;
