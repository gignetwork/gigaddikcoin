...
class RawTransactionsTest(GigAddikTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid gigaddik address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid gigaddik address" in e.error['message'])
