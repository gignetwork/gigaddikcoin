...
from test_framework.gigaddik_node import GigAddikTestNode
...
class GigAddik_ColdStakingTest(GigAddikTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(GigAddikTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, None, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 GIG from the pot)
