...
The build script we'll be using is contained in the GigAddik github repository ([contrib/gitian-build.py](https://https://github.com/gigaddik/GIG/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the GigAddik repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/gigaddik-maco/GigAddik/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, gigaddik-detached-sigs, and gigaddik GitHub repos.
