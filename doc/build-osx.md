...
1. Clone the GigAddik source code:
...
GigAddik is now available at `./src/gigaddikd`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/gigaddik"

    touch "/Users/${USER}/Library/Application Support/gigaddik/gigaddik.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/gigaddik/gigaddik.conf"

The first time you run gigaddikd, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.

You can monitor the download process by looking at the debug.log file:

    tail -f $HOME/Library/Application\ Support/gigaddik/debug.log

Other commands:
-------

    ./src/gigaddikd -daemon # Starts The GigAddik daemon.
    ./src/gigaddik-cli --help # Outputs a list of command-line options.
    ./src/gigaddik-cli help # Outputs a list of RPC commands when the daemon is running.
