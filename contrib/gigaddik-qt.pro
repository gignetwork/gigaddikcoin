...
RESOURCES += src/qt/gigaddik.qrc src/qt/gigaddik_locale.qrc

TRANSLATIONS += src/qt/locale/gigaddik_bg.ts \
                src/qt/locale/gigaddik_de.ts \
                src/qt/locale/gigaddik_en.ts \
                src/qt/locale/gigaddik_es.ts \
                src/qt/locale/gigaddik_fi.ts \
                src/qt/locale/gigaddik_fr.ts \
                src/qt/locale/gigaddik_it.ts \
                src/qt/locale/gigaddik_ja.ts \
                src/qt/locale/gigaddik_pl.ts \
                src/qt/locale/gigaddik_pt.ts \
                src/qt/locale/gigaddik_ru.ts \
                src/qt/locale/gigaddik_sk.ts \
                src/qt/locale/gigaddik_sv.ts \
                src/qt/locale/gigaddik_vi.ts \
                src/qt/locale/gigaddik_zh_CN.ts \
                src/qt/locale/gigaddik_zh_TW.ts
