...
This means one can have an always-on gigaddikd instance running, and another local gigaddikd/gigaddik-qt instance which connects to this node and receives blocks from it.
